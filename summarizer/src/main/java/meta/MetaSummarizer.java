...
import main.java.summarization.Score;
import main.java.summarization.Sentence;
import main.java.lexicalchaining.LexicalChain;
...
public class MetaSummarizer{
	...
	Properties props = PropertiesController.loadProperties();
	String sentFragModel = props.getProperty(props.getProperty(PropertiesController.EN_SENT_BIN_LOCATION));
	
	public MetaSummarizer(String posModelFile) throws Exception
	{
		Logger.getAnonymousLogger().info("Initializing Meta Summarizer");
		dp = (DocProcessor) new DefaultDocProcessor(sentFragModel);
